        ...
        <div className="col-lg-8 zoom">
          <div className="detailpictures">
            ...
            <div className="yarddetail">
              <h2 className="Detail-heading">{yard.Name} </h2>
              <p className="email">
                <i class="fa fa-envelope" aria-hidden="true"></i> {yard.Email}
              </p>
              <p className="phone">
                <i class="fa fa-phone" aria-hidden="true"></i> {yard.Phone}
              </p>
              <p className="address">
          ...
          <div className="listingdetails">
            <ul className="formlist">
              ...
              <li className="listcontent">
                <span>Website link of the business:</span> {yard.WebsiteUrl}
              </li>
              <li className="listcontent">
