                    ...
                    <div className="row cardetailcard">
                        ...
                        <div className="col-lg-5">
                            <div className="cardetaillist">
                               ...
                               <p className="endingin">Ending in: 8 days  hours 49 minutes 33 seconds</p>
                               <p className="bidcount">No Bid</p>
                               <p className="bidmessage">Reserve price has not been met by any bid.
</p>
<CFormGroup row>
                  <CCol md="3">
                  ...
                  <CCol xs="12" md="9">
                    <CInput id="text-input" name="text-input" placeholder="in $AUD " />
                    <p>(Enter 100.00 or more)</p>
                  </CCol>
                 
                </CFormGroup>
                          <button type="button"className="bidplace">Place Bid</button>
                            </div>
                        </div>
                    </div>
                    <div className="row">
