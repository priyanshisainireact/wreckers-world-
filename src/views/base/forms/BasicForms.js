          ...
          <CCard>
            ...
            <CCardBody>
              <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
               <CFormGroup row>
                  <CCol md="3">
                    <CLabel htmlFor="text-input">Blog Title</CLabel>
                  </CCol>
                  <CCol xs="12" md="9">
                    <CInput id="text-input" name="text-input" placeholder="Blog Title" />
                    <CFormText>Please enter blog title here</CFormText>
                  </CCol>
                </CFormGroup>
               {/* <CFormGroup row>
                  <CCol md="3">
              ...
              {/*   <CFormGroup row>
                ...
                <CFormGroup row>
                  <CCol md="3">
                    <CLabel htmlFor="textarea-input">Blog Text</CLabel>
                  </CCol>
                  <CCol xs="12" md="9">
                    <CTextarea 
                      name="textarea-input" 
